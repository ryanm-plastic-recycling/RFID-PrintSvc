...
6. Save the dynamic file under `C:\RFID\zpl` or deploy it with `Deploy-ZPL-Templates.bat`.
7. Run `GET /api/print/zpl-template-validation` and fix missing, tokenless, or wrong-station mappings before enabling a station/family scope.
