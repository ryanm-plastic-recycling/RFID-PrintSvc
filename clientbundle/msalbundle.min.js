...
${serverError}`);
  ...
  var BrowserConstants, PlatformAuthConstants, NativeExtensionMethod, BrowserCacheLocation, HTTP_REQUEST_TYPE, INTERACTION_TYPE, TemporaryCacheKeys, InMemoryCacheKeys, ApiId, InteractionType, DEFAULT_REQUEST, KEY_FORMAT_JWK, DB_NAME, DB_VERSION, DB_TABLE_NAME, CacheLookupPolicy, iFrameRenewalPolicies;
  ...
  var addClientCapabilitiesToClaims2;
  ...
  var PREFIX, BROWSER_PREFIX, CACHE_KEY_SEPARATOR, CREDENTIAL_SCHEMA_VERSION, ACCOUNT_SCHEMA_VERSION, LOG_LEVEL_CACHE_KEY, LOG_PII_CACHE_KEY, BROWSER_PERF_ENABLED_KEY, VERSION_CACHE_KEY, ACCOUNT_KEYS, TOKEN_KEYS;
  ...
  var USER_INTERACTION_REQUIRED, USER_CANCEL, NO_NETWORK, DISABLED, ACCOUNT_UNAVAILABLE, UX_NOT_ALLOWED;
